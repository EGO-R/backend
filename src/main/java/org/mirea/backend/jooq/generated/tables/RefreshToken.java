...
public class RefreshToken extends TableImpl<RefreshTokenRecord> {
     ...
     */
    public final TableField<RefreshTokenRecord, Long> USER_ID = createField(DSL.name("user_id"), SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>public.refresh_token.token_hash</code>.
     */
    public final TableField<RefreshTokenRecord, String> TOKEN_HASH = createField(DSL.name("token_hash"), SQLDataType.VARCHAR(256).nullable(false), this, "");

    /**
     * The column <code>public.refresh_token.expires_at</code>.
     */
    public final TableField<RefreshTokenRecord, LocalDateTime> EXPIRES_AT = createField(DSL.name("expires_at"), SQLDataType.LOCALDATETIME(6).nullable(false), this, "");
    ...
    public ClientsPath clients() {
        if (_clients == null)
            _clients = new ClientsPath(this, Keys.REFRESH_TOKEN__REFRESH_TOKEN_USER_ID_FKEY, null);
